...
/** Risposta 400 documentata una volta sola e riusata sui metodi che possono restituirla. */
@Target({ElementType.METHOD, ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@ApiResponse(
        responseCode = "400",
        description = "Dati della richiesta non validi: il campo fieldErrors elenca gli errori per singolo campo.",
        content = @Content(
