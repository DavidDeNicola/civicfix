...
/** Risposta 403 documentata una volta sola e riusata sui metodi che possono restituirla. */
@Target({ElementType.METHOD, ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@ApiResponse(
        responseCode = "403",
        description = "Autenticato, ma senza i permessi necessari per questa operazione.",
        content = @Content(
